/**
 * Authoritative India-Wide Administrative Location Dataset for AgriNexus Frontend
    ...
    districts: [
      {
        ...
        villages: [
          ...
          { localityCode: 'RJ_JAI_04', localityName: 'Bassi' }
        ]
      },
      {
        districtCode: 'RJ_JOD',
...
export const getDistrictsByState = (stateCodeOrName) => {
...
export const getVillagesByDistrict = (districtCodeOrName) => {
...
export const getDistrictCoordinates = (districtCodeOrName) => {
...
/**
 * Deterministic GPS Nearest District Locator (Haversine Formula)
 */
export const findClosestDistrictFromCoords = (lat, lon) => {
...
export const getLocationProvenance = () => {
