      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 sm:h-20 items-center">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-xs bg-forest-green border-2 border-dark-neutral flex items-center justify-center text-wheat-accent shadow-[2px_2px_0px_#22252A] group-hover:-translate-x-0.5 group-hover:-translate-y-0.5 transition-transform">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <Link to="/access">
              <button
                type="button"
                className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-2 sm:py-2.5 min-h-[44px] sm:min-h-[48px] rounded-xs border-2 sm:border-3 border-dark-neutral bg-forest-green text-white text-xs sm:text-sm font-black tracking-wide shadow-brutal-sm hover:-translate-x-[1px] hover:-translate-y-[1px] hover:shadow-brutal active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-all duration-micro ease-tactile focus-visible:ring-2 focus-visible:ring-dark-neutral focus-visible:outline-none"
              >
